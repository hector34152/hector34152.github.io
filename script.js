...
function changeInfo(a){
    let personal =[
        "<ul id='personal'><h2>Hector Guadalupe Flores Picazo</h2><div><h2 id='name'>WEB DEVELOPER IN PROCESS....<span id='span'>&#160;</span></h2></div><div><h3>Bienvendo a mi portafolio como desarrollador web.</h3></li><div><p>Para ponerte en contacto conmigo tienes mis redes sociales aqui abajo, da cliq a la imagen.</p></div><div id='social'><div><a href='https://www.instagram.com/florespicazohector?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=='><img src='img/coleccion-logotipos-modernos-redes-sociales-acuarela_1361-346-removebg-preview.png' width='30%'></a></div><div><a href='https://wa.me/524921924116'><img src='img/whatsap.png' width='30%'></a></div></div></ul>",
        ...
        "<button type='button'><a href='/Programing/Proyectos/Calculadora lap/index.html'>Calculadora</a></button> <button type='button'><a href='/Programing/Proyectos/TicTacToe lap/index.html'>Tic tac toe</a></button>",
